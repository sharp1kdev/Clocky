...
from avatar import BOT, LOGS
from avatar import __copystring__, __version__
from avatar.helpers import time_has_changed, convert_time_to_string, get_photos_id_list

LOGS.info("Starting avatar...")
BOT.start()
ME = BOT.get_me().username
LOGS.info(__copystring__)
LOGS.info(f"You're logged in as \"{ME}\"!")
LOGS.info(f"Your avatar is Version {__version__}\n")
